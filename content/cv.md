...
*All projects supervised by Prof. Zhan Song at the Machine Vision Research Center of SIAT.*
...
**Polarized Structured Light System for High-reflective Surfaces**  
   *Nov. 2022 – Mar. 2023*  
   ...
   - Developed a high dynamic range fusion algorithm to merge point clouds into a unified model.

---

## ⚙️ Skills

- **Programming:** C++ (Mainly Use), Python (PyTorch), MATLAB, LaTeX.
